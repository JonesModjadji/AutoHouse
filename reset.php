...
$error="";
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $myname = mysqli_real_escape_string($con,$_POST['Username']);
      $mypassword =$_POST['Password']; 
	  $rePass =$_POST['repass']; 
      
      $sql = "SELECT * FROM users WHERE Username = '$myname'";
      ...
      if($count == 1) {
         if($mypassword == $rePass){
			 ...
			 //Update statement
			 $sql = "UPDATE users SET Password='$rePass' WHERE Username='$myname'";
			 $result = mysqli_query($con,$sql);
			 if($result){
...
<p><?php echo $error; ?></p>
<input type="text" name="Username" required="" placeholder="UserName" style="width:60%;">
